...
public class BiomeDevonianCreekLycopsidSpinney extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:devonian_creek_lycopsid_spinney")
	public static final BiomeGenCustom biome = null;
	public BiomeDevonianCreekLycopsidSpinney(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeDevonian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Devonian Cold Glades Creek").setRainfall(0.5F).setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.25F));
			setRegistryName("lepidodendron:devonian_creek_lycopsid_spinney");
