...
public class BiomeDevonianOceanDeep extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeDevonian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Devonian Ocean").setRainfall(0.5F).setBaseHeight(-1.90F).setHeightVariation(0.08F).setTemperature(1.5F));
			setRegistryName("lepidodendron:devonian_ocean_deep");
