...
public class BiomeDevonianMeadow extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:devonian_meadow")
	public static final BiomeGenCustom biome = null;
	public BiomeDevonianMeadow(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeDevonian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Devonian Wet Meadow").setRainfall(0.2F).setBaseHeight(-0.1F).setHeightVariation(0.08F).setTemperature(1.5F).setWaterColor(3906905));
			setRegistryName("lepidodendron:devonian_meadow");
