...
public class BiomeDevonianLagoonHelper extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:devonian_lagoon_helper")
	public static final BiomeGenCustom biome = null;
	public BiomeDevonianLagoonHelper(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeDevonian {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Devonian Arid Lagoons").setRainfall(0.9F).setBaseHeight(0.065F).setHeightVariation(0.0F).setTemperature(2.25F));
			setRegistryName("lepidodendron:devonian_lagoon_helper");
