...
public class BiomeDevonianGilboa extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:devonian_gilboa")
	public static final BiomeGenCustom biome = null;
	public BiomeDevonianGilboa(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
