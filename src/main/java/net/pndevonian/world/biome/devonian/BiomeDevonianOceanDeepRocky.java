...
public class BiomeDevonianOceanDeepRocky extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:devonian_ocean_deep_rocky")
	public static final BiomeGenCustom biome = null;
	public BiomeDevonianOceanDeepRocky(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
