...
public class BiomeDevonianOceanAlgae extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:devonian_ocean_algae")
	public static final BiomeGenCustom biome = null;
	public BiomeDevonianOceanAlgae(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeDevonian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Devonian Algal Ocean").setRainfall(0.5F).setBaseHeight(-0.40F).setHeightVariation(0.00F).setTemperature(1.5F).setWaterColor(-3936709));
			setRegistryName("lepidodendron:devonian_ocean_algae");
