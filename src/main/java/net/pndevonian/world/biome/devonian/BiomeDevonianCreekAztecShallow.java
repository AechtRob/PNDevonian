...
public class BiomeDevonianCreekAztecShallow extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:devonian_creek_aztec_shallow")
	public static final BiomeGenCustom biome = null;
	public BiomeDevonianCreekAztecShallow(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeDevonian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Devonian Floodplain").setRainfall(0.5F).setBaseHeight(-0.275F).setHeightVariation(0.0F).setTemperature(0.6F));
			setRegistryName("lepidodendron:devonian_creek_aztec_shallow");
