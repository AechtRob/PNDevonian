...
public class GenLayerDiversifyGilboaLake extends GenLayer {


    public Biome DEVONIAN_FOREST = Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:devonian_gilboa"));
    public int DEVONIAN_FOREST_ID =  Biome.getIdForBiome(DEVONIAN_FOREST);
    public Biome DEVONIAN_POOLS = Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:devonian_gilboa_lake"));
    ...
    public GenLayerDiversifyGilboaLake(long seed, GenLayer genLayer)
    {
        super(seed);
