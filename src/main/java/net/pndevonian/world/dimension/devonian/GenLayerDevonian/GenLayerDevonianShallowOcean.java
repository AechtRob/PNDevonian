...
public class GenLayerDevonianShallowOcean extends GenLayer
{
    ...
    public GenLayerDevonianShallowOcean(long seed, GenLayer genLayer)
    {
        super(seed);
    ...
    private boolean hasDeepSea(int biomeID) {
        if (biomeID == DEVONIAN_MOUNTAINS_ID || biomeID == DEVONIAN_OCEAN_ID || biomeID == DEVONIAN_OCEAN_SHORE_ID) {
            return true;
        }
        return false;
    }
