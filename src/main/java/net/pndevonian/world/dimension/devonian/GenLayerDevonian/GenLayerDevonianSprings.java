...
public class GenLayerDevonianSprings extends GenLayer
{

    public Biome DEVONIAN_MOUNTAINS = Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:devonian_mountains_early"));
    public int DEVONIAN_MOUNTAINS_ID =  Biome.getIdForBiome(DEVONIAN_MOUNTAINS);
    public Biome DEVONIAN_VALE = Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:devonian_springs"));
    ...
    public GenLayerDevonianSprings(long seed, GenLayer genLayer)
    {
        super(seed);
