...
@Mod(modid = PNDevonianMod.MODID, name = PNDevonianMod.NAME, version = PNDevonianMod.VERSION, dependencies = "required-after:lepidodendron@[60.03,)")
public class PNDevonianMod {
    ...
    @Mod.Instance(MODID)
    public static PNDevonianMod instance;
    public ElementsPNDevonianMod elements = new ElementsPNDevonianMod();
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsPNDevonianMod.GuiHandler());
